...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        error.setFont(new java.awt.Font("Microsoft Tai Le", 2, 12)); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/logos/tpesLOGOright.jpg"))); // NOI18N
    ...
    TPES db=new TPES();
        ...
        try{
            ...
            error.setText("Enter valid details | ID or password");
        }catch(Exception e){
              e.printStackTrace();        
        }
